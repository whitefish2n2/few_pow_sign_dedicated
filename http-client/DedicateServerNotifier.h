...
public:
    ...
    void init(const std::string& clientIpPort);
    ...
    void notifyDedicatedServerUp(const std::string &key, const std::string &ip, const std::string &url, const std::string &udpPort, const std::vector<std
